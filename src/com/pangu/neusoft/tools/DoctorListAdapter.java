...
import com.pangu.neusoft.adapters.HospitalListViewHolder;
...
public class DoctorListAdapter extends ArrayAdapter<HospitalList> {  
  
          
        private AsyncBitmapLoader asyncImageLoader;  
  
        public DoctorListAdapter(Activity activity, List<HospitalList> imageAndTexts) {  
