...
public class PushMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (intent.getAction().equals(PushConstants.ACTION_MESSAGE)) {
			...
			responseIntent.setClass(context, FristActivity.class);
		...
		//可选。通知用户点击事件处理
			...
			aIntent.setClass(context, FristActivity.class);
			String title = intent
        	...
        	Intent clickintent = new Intent(context.getApplicationContext(),FristActivity.class);
